...
const isAuthorReview = require('../middlewares/isAuthor').isAuthorReview;
...
router.delete('/:reviewId', isAuth, isAuthorReview, isValidObjectId('/places'), wrapAsync(async (req, res) => {
