...
async function seedPlaces() {
    const places = [
        {
            title: 'Unesa',
            price: 0,
            description: 'Universitas Negeri Surabaya, kampus no 1 se Indonesia. Memiliki lebih dari 4 kampus yang tersebar di nusantara. Memiliki fasilitas super lengkap',
            location: 'Jl. Ketintang, Ketintang, Kec. Gayungan',
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1715586042479-256282ff3cc9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D/'
        },
        // {
        //     title: 'Pantai Kuta',
        //     price: 0,
        ...
        //     image: 'https://source.unsplash.com/collection/8953189/'
        // },
        // {
        //     title: 'Kawah Putih',
        //     price: 0,
        ...
        //     image: 'https://source.unsplash.com/collection/8953189/1280x720'
        // },
        // {
        //     title: 'Malioboro',
        //     price: 0,
    ...
    try {
        const newPlace = places.map(place => {
            return {
                ...place, 
                author: '679f15ef8e4647bb421bd351', 
                images: {
                    url: 'C:\\Users\\arman\\vsc\\DirectoryListingApp\\public\\images\\image-1738567963896-511644333.jpeg',
                    filename: 'image-1738567963896-511644333.jpeg'
                }
            }
        })
